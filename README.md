# Mobile Remote Radio Control (MRRC) V6.1.12

[![English](https://img.shields.io/badge/lang-English-blue.svg)](README_en.md)
[![中文](https://img.shields.io/badge/lang-中文-red.svg)](README_CN.md)
[![Version](https://img.shields.io/badge/version-V6.1.12-green.svg)](CHANGELOG.md)
...
> 🎉 **V6.1.12 更新**: **一键升级**（有新版本时点一下/按 U 即可，自动下载校验 + 静默安装 + 自动重启，支持回退上一版）。

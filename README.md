...
[![Version](https://img.shields.io/badge/version-V5.1.0-green.svg)](CHANGELOG.md)
...
> 🎉 **V5.1.0 更新**: RagChew TX 语音美化 — 温暖自然的人声EQ、动态压缩、噪声门控
>
...
**Latest Release: V5.1.0** (2026-05-10) | [View Changelog](CHANGELOG.md)

...
This directory contains a new mobile-optimized web interface for the Universal HamRadio Remote (MRRC) system, specifically designed for iPhone 15 and other modern mobile devices.
...
The new mobile interface maintains full compatibility with the existing MRRC backend:

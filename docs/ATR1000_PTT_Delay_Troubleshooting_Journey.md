...
**文件**: `/Users/cheenle/MRRC/MRRC_mac/MRRC`
...
使用专门的音频中间件（如 PulseAudio/PipeWire）处理音频流，MRRC 只负责控制协议。

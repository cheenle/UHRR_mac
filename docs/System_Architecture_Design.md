...
ATR-1000功率流:
ATR-1000设备 → 独立代理(atr1000_proxy.py) → Unix Socket → UHRR桥接 → WebSocket(/WSATR1000) → 移动端显示
...
| v4.5.0 | 2026-03-06 | ATR-1000实时功率显示稳定版 | 生产就绪 |
| v4.5.1 | 2026-03-06 | 频率调整按钮布局优化 | 当前版本 |

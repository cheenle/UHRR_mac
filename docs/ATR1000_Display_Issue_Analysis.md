...
```
ATR-1000设备 → WebSocket → 独立代理 → Unix Socket → UHRR桥接 → WebSocket → 前端显示
    (1)          (2)         (3)         (4)          (5)         (6)        (7)
```
...
| (4) Unix Socket | 代理通过 Unix Socket 发送到 UHRR |
| (5) 桥接广播 | UHRR 桥接器批量广播到前端 |

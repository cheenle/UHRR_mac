...
| RX 批量发送 | 8 帧/批次 | UHRR:911-930 | 减少 WebSocket 开销 |
| PTT 超时计数 | 10 次 | UHRR:688-698 | 200ms 检查间隔 |
...
UHRR 项目的音频流实现已经经过了多轮优化，当前的架构设计合理，性能表现良好。以下是主要结论：
...
| RX 批量发送 | `UHRR` | 911-930 |
| PTT 超时机制 | `UHRR` | 688-698 |
